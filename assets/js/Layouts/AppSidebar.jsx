        ...
        <div className='sidebar-wrapper'>
            <div className="sidebar-header position-relative">
                <div className="d-flex justify-content-between align-items-center">
                        <div className="logo">
                            <a style={{cursor: 'pointer'}} href="index.html"><img src="http://localhost:3000/static/dist/compiled/svg/logo.svg" alt="Logo" srcSet=""/></a> {/*  TODO :: Need to fix this */}
                        </div>
                        <div className="theme-toggle d-flex gap-2  align-items-center mt-2">
                            ...
                            <div className="form-check form-switch fs-6">
                                <input style={{cursor: 'pointer'}} className="form-check-input  me-0" type="checkbox" id="toggle-dark" onChange={toggleTheme} checked={theme === 'dark'}/>
                        ...
                        <div style={{cursor: 'pointer'}} onClick={toogleSideBar} className="sidebar-toggler  x">
...
//                         <Link href='/' className="sidebar-link">Todo</Link>
//                     </li>
//                     <li className="sidebar-item">
